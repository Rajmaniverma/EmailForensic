...
function AnalyzerDashboard() {
  ...
  const urls = Array.isArray(email?.urls)
    ? email.urls
    : [];
  ...
  const phishingScore = Number(
    phishing?.phishing_score || 0
  );

  const socialScore = Number(
    social?.social_engineering_score ??
      social?.score ??
      0
  );

  const legitimateScore = Number(
    phishing?.legitimate_score || 0
  );
  ...
  const overallRisk = useMemo(() => {
    if (phishingScore >= 70 || socialScore >= 70) {
      return {
        ...
        className:
          "bg-[#fce8e6] text-[#c5221f] border-[#f5c2c0]",
        dot: "bg-[#d93025]",
      };
    }
    ...
    if (phishingScore >= 40 || socialScore >= 40) {
      return {
        ...
        className:
          "bg-[#fef7e0] text-[#b06000] border-[#f6d98b]",
        dot: "bg-[#f9ab00]",
      };
    }
    ...
    return {
      label: "Low Risk",
      text:
        "No strong phishing or social-engineering score was detected.",
      className:
        "bg-[#e6f4ea] text-[#137333] border-[#b7dfc2]",
      dot: "bg-[#1e8e3e]",
    };
  ...
  const openTool = (path) => {
    ...
    navigate(
      `${path}?message_id=${encodeURIComponent(messageId)}`
    );
  };
            ...
            <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
              ...
              <div className="rounded-2xl bg-white/10 border border-white/15 px-5 py-4 min-w-[220px]">
                ...
                <div className="mt-1 flex items-center gap-2">
                  ...
                  <span
                    className={`w-2.5 h-2.5 rounded-full ${overallRisk.dot}`}
                  />
        ...
        {!analysis && !analyzing && (
          <section className="mt-6 rounded-3xl border border-[#d2e3fc] bg-white p-8 text-center shadow-sm">
            ...
            <p className="mt-2 max-w-xl mx-auto text-sm leading-6 text-[#5f6368]">
              Run the analysis once. MailGuard will collect
              the general forensic and authentication
              information for this dashboard.
            </p>
          ...
          <>
            ...
            <section className="mt-6 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
              ...
              <MetricCard
                ...
                helper="Overall email assessment"
                tone={
                  overallRisk.label === "High Risk"
                    ? "danger"
                    : overallRisk.label === "Suspicious"
                      ? "warning"
                      : "success"
                }
              />
              ...
              <MetricCard
                ...
                value={
                  [
                    ...
                    (item) =>
                      normalizeAuthValue(item) ===
                      "PASS"
                  ).length + "/3"
                }
                helper="SPF / DKIM / DMARC passed"
                tone="blue"
              />
            ...
            {/* =================================================
                OVERALL SECURITY POSTURE + MODULES
            ================================================== */}

            <section className="mt-6 grid grid-cols-1 xl:grid-cols-[1.35fr_0.65fr] gap-5">

              <div
                className={`rounded-3xl border p-6 ${overallRisk.className}`}
              >
            ...
            <section className="mt-6">
              ...
              <Panel
                ...
                subtitle="Sender authentication and domain verification"
                icon="🔐"
              >
                ...
                <div className="mt-5 rounded-2xl bg-[#f8f9fa] p-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                    ...
                    <InfoBox
                      label="SPF"
                      value={formatAuthenticationValue(spf)}
                    />

                    <InfoBox
                      label="DKIM"
                      value={formatAuthenticationValue(dkim)}
                    />

                    <InfoBox
                      label="DMARC"
                      value={formatAuthenticationValue(dmarc)}
                    />
            ...
            <section className="mt-6">
              ...
              <Panel
                ...
                subtitle="Originating IP address and basic location"
                icon="🌐"
              >
            ...
            <section className="mt-6">
              ...
              <Panel
                ...
                subtitle="Identity and routing details"
                icon="✉️"
              >
            ...
            <section className="mt-6 grid grid-cols-1 xl:grid-cols-2 gap-5">
              ...
              <Panel
                title="URL Evidence"
                subtitle="Links discovered in the message"
                icon="🔗"
              >
              ...
              <Panel
                title="Attachments"
                subtitle="Files detected in the email"
                icon="📎"
              >
  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between gap-3">
        ...
        <span
          className={`px-3 py-1 rounded-full text-[10px] font-bold uppercase ${statusClass}`}
        >
          {normalized}
        </span>
          ...
          <p className="mt-0.5 text-xs text-[#5f6368]">
            ...
            {passed
              ...
              : failed
                ...
                : "No authentication result available"}
...
function MetricCard({
  ...
  const tones = {
    ...
    blue:
      "bg-[#e8f0fe] border-[#c6dafc]",

    purple:
      "bg-[#f3e8fd] border-[#dec5f2]",
  };
  ...
  return (
    ...
    >
      ...
      <p className="mt-4 text-2xl font-bold break-all">
        {value}
      </p>
...
function MetaRow({
  ...
  return (
    <div className="grid grid-cols-[90px_1fr] gap-3 text-xs">
      ...
      <span className="font-semibold text-[#80868b]">
        {label}
      </span>

      <span className="text-[#3c4043] break-words">
        {formatValue(value)}
      </span>
...
function formatAuthenticationValue(value) {
  if (Array.isArray(value)) {
