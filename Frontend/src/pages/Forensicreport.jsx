...
const Forensicreport = () => {
  ...
  useEffect(() => {
    const fetchreport = async () => {
      try {
        ...
        console.log("Analysis_report:", result);
      ...
      <div className="min-h-screen bg-slate-950 text-white flex items-center justify-center">
        ...
        <div className="text-center">
          ...
          <p className="text-sm text-slate-400 mt-2">
            Retrieving analysis from secure cache...
          </p>
      ...
      <div className="min-h-screen bg-slate-950 text-white flex items-center justify-center px-6">
        ...
        <div className="text-center max-w-md">
          ...
          <p className="text-slate-400 mb-6">
            {error || "No forensic analysis was found."}
          </p>
  ...
  /*
    Your backend currently stores IP analysis under:

        ip_tracing

    NOT ip_forensics

    because your backend result is:
...
const threatScore = report.detection_engine.ai_analysis?.threat_score ?? 0;
const safeScore = report.detection_engine.ai_analysis?.safe_score ?? 0;
const email = report?.email || {};
const ai = report.detection_engine?.ai_analysis || {};
  // =====================================================
  // RISK CLASS
  // =====================================================
  ...
  const getRiskClass = () => {
    ...
    switch (
      report.detection_engine.ai_analysis.risk_level?.toLowerCase() || {}
    ) {
  ...
  return (
    <div className="min-h-screen bg-slate-100 text-slate-900">
      ...
      >
        ...
        ================================================= */}
        const ipForensics =
  report?.ip_tracing?.ip_forensics?.ip_records || [];
        ...
        <section className="px-10 pb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <AuthCard
              title="SPF"
              data={email?.authentication?.spf}
            />

            <AuthCard
              title="DKIM"
              data={email?.authentication?.dkim}
            />

            <AuthCard
              title="DMARC"
              data={email?.authentication?.dmarc}
            />
        ...
        <section className="px-10 pb-10">
          ...
          <div className="border rounded-xl p-6 bg-slate-50">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <AnalysisItem
                label="Urgency"
                value={ai?.subject_analysis?.urgency}
              />

              <AnalysisItem
                label="Threats"
                value={ai?.subject_analysis?.threats}
              />

              <AnalysisItem
                label="Financial Request"
                value={
                  ai?.subject_analysis?.financial_request
                }
              />
              ...
              <AnalysisItem
                ...
                value={
                  ai?.subject_analysis?.credential_request
                }
              />
              ...
              <AnalysisItem
                ...
                value={
                  ai?.subject_analysis?.unusual_language
                }
              />

              <AnalysisItem
                label="Fear"
                value={ai?.body_analysis?.fear}
              />

              <AnalysisItem
                label="Pressure"
                value={ai?.body_analysis?.pressure}
              />

              <AnalysisItem
                label="Password Request"
                value={
                  ai?.body_analysis?.password_request
                }
              />
...
<section className="px-10 pb-10">
  ...
  {Array.isArray(ipForensics) && ipForensics.length > 0 ? (

    <div className="space-y-6">

      {ipForensics.map((record, index) => {

        const geo = record?.geolocation || {};
        const network = record?.network || {};
        const anon = record?.anonymization || {};
...
const Info = ({ label, value }) => (
  ...
  <div className="p-4 border-b md:border-r last:border-r-0">
